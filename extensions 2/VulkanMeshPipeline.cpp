                                        ...
                                        VkPipelineCache pipelineCache)
{
    ...
    shaderStages[0] = loadShader(shadersPath + "mesh_debug_printf.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] = loadShader(shadersPath + "mesh_debug_printf.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
#else
    shaderStages[0] = loadShader(shadersPath + "mesh_debug.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] = loadShader(shadersPath + "mesh_debug.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
    #endif
#endif
